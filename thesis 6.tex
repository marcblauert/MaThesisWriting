...
\caption{Comparison between full sample and subsample}
\label{tab:sample-comparison}
\begin{tabular}{@{}lllll@{}}
\toprule
Variable                                                                                       & Energy carrier group & \begin{tabular}[c]{@{}l@{}}Full sample\\ (N = 2.719.270)\end{tabular}

\&
\begin{tabular}[c]{@{}l@{}}Sub-sample\\ (N = 4.410)\end{tabular}

\& Difference \{{[}\}\%\{{]}\} \textbackslash{} \midrule
\multirow{3}{*}{\begin{tabular}[c]{@{}l@{}}Energy demand\\ {[}kWh/m2{]}\end{tabular}} \& Gas \& 122.5 \{{[}\}56.4; 209.33\{{]}\} \& 121.39 \{{[}\}55.4; 211.32\{{]}\} \& -0.91 \{{[}\}-1.81; 0.94\{{]}\} \textbackslash{}
\& Oil \& 122.36 \{{[}\}58.67; 204\{{]}\} \& 116.97 \{{[}\}53.57; 198.17\{{]}\} \& -4.61 \{{[}\}-9.52; -2.94\{{]}\} \textbackslash{}
\& District heating \& 89.38 \{{[}\}43.23; 156.88\{{]}\} \& 83.98 \{{[}\}41.92; 141.01\{{]}\} \& -6.43 \{{[}\}-3.12; -11.25\{{]}\} \textbackslash{}
\multirow{3}{*}{\begin{tabular}[c]{@{}l@{}}Energy price\\ {[}Cents/kWh{]}\end{tabular}} \& Gas \& 6.28 \{{[}\}4.56; 8.14\{{]}\} \& 6.22 \{{[}\}4.59; 8.04\{{]}\} \& -0.96 \{{[}\}0.65; -1.24\{{]}\} \textbackslash{}
\& Oil \& 7.14 \{{[}\}5.1; 9.18\{{]}\} \& 7.21 \{{[}\}5.2; 9.23\{{]}\} \& 0.97 \{{[}\}1.92; 0.54\{{]}\} \textbackslash{}
\& District heating \& 10.45 \{{[}\}6.86; 15.07\{{]}\} \& 10.76 \{{[}\}7.17; 16.15\{{]}\} \& 2.88 \{{[}\}4.32; 6.69\{{]}\} \textbackslash{}
\multirow{3}{*}{Degree days} \& Gas \& 3467.6 \{{[}\}2921.14; 4180.42\{{]}\} \& 3461.14 \{{[}\}2914.56; 4180.4\{{]}\} \& -0.19 \{{[}\}-0.23; 0\{{]}\} \textbackslash{}
\& Oil \& 3568.13 \{{[}\}2971.7; 4269.19\{{]}\} \& 3582.48 \{{[}\}2946.19; 4318.42\{{]}\} \& 0.4 \{{[}\}-0.87; 1.14\{{]}\} \textbackslash{}
\& District heating \& 3441.1 \{{[}\}2924.64; 4137.61\{{]}\} \& 3447.97 \{{[}\}2948.92; 4180.11\{{]}\} \& 0.2 \{{[}\}0.82; 1.02\{{]}\} \textbackslash{}
\multirow{3}{*}{\begin{tabular}[c]{@{}l@{}}Building heating \\ surface {[}sqm{]}\end{tabular}} \& Gas \& 648.84 \{{[}\}163; 1849.4\{{]}\} \& 727.47 \{{[}\}168.04; 1817\{{]}\} \& 10.81 \{{[}\}3; -1.78\{{]}\} \textbackslash{}
\& Oil \& 452.82 \{{[}\}160; 1195.6\{{]}\} \& 489.55 \{{[}\}167.1; 1362.8\{{]}\} \& 7.5 \{{[}\}4.25; 12.27\{{]}\} \textbackslash{}
\& District heating \& 1714.09 \{{[}\}255; 5030.18\{{]}\} \& 2034.55 \{{[}\}297.52; 6968.98\{{]}\} \& 15.75 \{{[}\}14.29; 27.82\{{]}\} \textbackslash{} \midrule
\multicolumn{5}{l}{\textit{*) Mean {[}90\% CI{]}}}\\
\textbackslash end\{tabular\}
\textbackslash end\{table\}

Table \ref{tab:sample-comparison} compares the full and the subsample in key variables.
