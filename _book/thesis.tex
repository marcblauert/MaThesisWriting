...
\textit{} &  &  &  &  \\
\textit{\begin{tabular}[c]{@{}l@{}}Price\\ \end{tabular}} & (Average) Energy price & Continuous & ln(Cents/kWh) & Ista (billing dataset)\\
\textit{} &  &  &  &  \\
