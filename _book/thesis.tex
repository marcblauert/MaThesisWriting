...
\tightlist
\item
  Also estimate long-term elasticities (beyond the scope of this thesis) --\textgreater{} scrutinize the intuition that long-term elasticities are lower for the rental segment than for own homes.
\end{itemize}
\appendix
