...
\bigskip \bigskip \noindent
\begin{tabular}{m{14cm}} \hline \textbf{Link to GitHub repository:}                                                            \\ \footnotesize \url{https://github.com/marcblauert/price_elasticities_heating_demand_thesis}    \\ \hline \end{tabular}
}
...
\textbf{Energy performance certificates (EPC) dataset}
...
{\centering \includegraphics[width=1.03\linewidth]{figure/workflow_diagramm_1} 
...
\textbf{Sub-sampling and Bayesian regression analysis}
...
\leavevmode\vadjust pre{\hypertarget{ref-michelsen_rosenschon12}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-nei22}{}}%
