...
**Energy price affecting space heat demand**

The starting point for the conceptual model is the relationship between space heating demand and energy price. Here, the basic assumption from the theory of price and demand is that the demand for space heating is influenced by the energy price. When the price goes up, demand moves down along the demand curve and vice versa (see Figure \@ref(fig:elasticities-conceptual)). Transferred to a statistical terminology this implies that space heat demand is the response variable of a model and energy price the main explanatory variable. To support the development of the conceptual model visually, Figure \@ref(fig:dag) depicts it as a directed acyclic graph (DAG).[^11] In the center, the space heat demand is shown, the variance of which is to be explained (yellow bubble). Since the effect of energy price (purple bubble) on space heating demand is to be regarded as the price elasticity, it is marked with a red arrow.
