...
```
\noindent
Figure \@ref(fig:plot-model-comparison) presents a visual examination of the model fit for all models used on the subsample analysis. ADJUST!!!!
